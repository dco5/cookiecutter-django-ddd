...
LOCAL_APPS = [
    "{{ cookiecutter.project_slug }}.data.users",
...
{%- endif %}
    ...
    "{{ cookiecutter.project_slug }}.contrib.middlewares.current_user.CurrentUserMiddleware",
...
TEMPLATES = [
    {
        ...
        "DIRS": [str(APPS_DIR / "interface" / "web" / "templates")],
